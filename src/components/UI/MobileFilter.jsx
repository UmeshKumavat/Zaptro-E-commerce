...
const MobileFilter = ({openFilter,setOpenFilter,search, setSearch,handleInputSearch,selectedCategory,setSelectedCategory,selectedBrand,setSelectedBrand,priceRange,setPriceRange,handleCategoryChange,handleBrandChange,handleResetFilter,}) => {
  const { categories, brandData } = getData();
  return (
    <>
      <div className="bg-gray-100 md:hidden flex justify-between items-center px-4 p-2 mt-5 shadow-2xl rounded-md">
        ...
        <div className="bg-gray-100 p-2 md:hidden">
          ...
          >
            {brandData?.map((brand, index) => {
              return (
                <option key={index} value={brand} className="w-[300px]">
                  {brand}
                </option>
              );
            })}
          ...
          <div className="flex flex-col gap-2 mt-3">
            ...
            <input
              ...
              className="accent-red-500 cursor-pointer w-[200px]"
            />
          </div>
          <button
